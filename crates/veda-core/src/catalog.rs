...
pub fn default_catalog() -> Catalog {
    ...
    Catalog {
        ...
        assets: vec![
            ...
            docset_source("python-source-3.14.7", "Python 3.14.7 documentation", crate::DocsetId::Python, "https://docs.python.org/3/archives/python-3.14-docs-html.zip", "9306da398ae5a9142deb22d5c7865994fe0ada961022c8dea8ee341348e1481", 16_740_440, "python-3.14-docs-html", "PSF-2.0"),
