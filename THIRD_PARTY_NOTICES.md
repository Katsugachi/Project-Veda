...
- Original model: OpenBMB MiniCPM5-1B
- Selected GGUF repository: Abiray/MiniCPM5-1B-GGUF
- License declared by the repository/model: Apache License 2.0
- https://huggingface.co/openbmb/MiniCPM5-1B
- https://huggingface.co/Abiray/MiniCPM5-1B-GGUF
...
- GGUF conversion: CompendiumLabs/bge-small-en-v1.5-gguf
- License declared by the GGUF repository: MIT
...
- Code examples are additionally available under the Zero-Clause BSD License where stated.
...
Rust and JavaScript dependencies retain their respective licenses. A release build should generate and ship a full dependency license report alongside this notice.
